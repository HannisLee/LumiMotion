...
本文只记录 Stage1 `photometric_lambertian` 路线中 V1、V2、V3 的核心改动。具体命令、参数和实验结果仍以各版本专门文档为准。

## 文档入口

| 版本 | 主要文档 | 代码/实验定位 |
| --- | --- | --- |
| V1 | `DOC/LH-static-stage1V1.md`、`DOC/Archive/version01.md` | 最小 photometric Lambertian Stage1 baseline |
| V2 | `DOC/LH-static-stage1-V2.md`、`DOC/stage1-V2-Code_spec.md` | photometric initialization、分阶段训练、两种 light 参数化 |
| V3 / V3.1 | `DOC/stage1-V3.1-参数.md` | 删除曲线参数化，回到 per-frame light table，并加入 16 相位 multistart |
...
### V2-a：per-frame directional light table
...
### V2-b：B-spline / control points directional light
...
| 项目 | V1 | V2-a per-frame | V2-b B-spline | V3 / V3.1 |
| --- | --- | --- | --- | --- |
